...
In the first run, with Nb\_iterations = 100, 43 solutions have been explored before the finding of the local minima. So, for each of them, the best solution is displayed. It’s the result of the exploration of all the neighbor.
\begin{table}[h]
    \centering
    \small
    \begin{tabular}{llll}
